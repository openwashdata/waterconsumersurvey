...
data_in <- readr::read_csv("data-raw/water consumer survey.csv")
...
readr::write_csv(waterconsumersurvey,
                 here::here("inst", "extdata", paste0("waterconsumersurvey", ".csv")))
openxlsx::write.xlsx(waterconsumersurvey,
                     here::here("inst", "extdata", paste0("waterconsumersurvey",
                                                          ".xlsx")))
